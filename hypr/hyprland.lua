...
--
 ...
 hl.exec_cmd("udiskie")
 hl.exec_cmd("dex ~/.config/autostart/apparmor-notify.desktop")
...
hl.config({
    ...
    general = {
        ...
        col = {
            active_border   = { colors = {colors.outline}, angle = 45 },
...
--hl.layer_rule({ match = { namespace = "swayosd" }, ignore_alpha = 0.5 })
hl.layer_rule({ match = { namespace = "swaync-control-center" }, animation = "slide right" })
hl.layer_rule({ match = { namespace = "rofi" }, animation = "popin 87%" })
...
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("kitty -e vim"))
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd(ipc .. "panel-toggle control-center"))
hl.bind(mainMod .. " + Z", hl.dsp.exec_cmd("kitty -e btop"))
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd(ipc .. "panel-toggle clipboard"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd(ipc .. "bar-toggle"))
hl.bind(mainMod .. " + X", hl.dsp.exec_cmd(ipc .. "panel-toggle session"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(ipc .. "panel-toggle wallpaper"))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd("brave-origin"))
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("~/Scripts/hyprpicker.sh"))
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd("~/Scripts/gamemode.sh"))
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd(ipc .. "window-switcher"))
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd(ipc .. "session lock"))
hl.bind(mainMod .. " + C", hl.dsp.exec_cmd(ipc .. "wallpaper-random"))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd(ipc .. "settings-toggle"))
...
hl.bind(mainMod .. " + CTRL + right", hl.dsp.window.resize({ x = resizeUnit, y = 0, relative=true }), {repeating = true})
hl.bind(mainMod .. " + CTRL + left", hl.dsp.window.resize({ x = -resizeUnit, y = 0, relative=true }), {repeating = true})
hl.bind(mainMod .. " + CTRL + up", hl.dsp.window.resize({ x = 0, y = -resizeUnit, relative=true }),   {repeating = true})
hl.bind(mainMod .. " + CTRL + down", hl.dsp.window.resize({ x = 0, y = resizeUnit, relative=true }),  {repeating = true})
